...
class IFMapApiGenerator(object):
    ...
    def _generate_client_classes(self, gen_filepath_pfx, gen_filename_pfx):
        ...
        for ident in self._non_exclude_idents():
            ...
            write(gen_file, "        props_dict = {}")
            write(gen_file, "")
            write(gen_file, "        # Common fields to dictionary")
            ...
            write(gen_file, "               refs_dict = dict(r)")
            write(gen_file, "               if 'attr' in refs_dict:")
            write(gen_file, "                   refs_dict['attr'] = refs_dict['attr'].to_dict(None)")
            write(gen_file, "               props_dict[ref].append(refs_dict)")
            write(gen_file, "")
