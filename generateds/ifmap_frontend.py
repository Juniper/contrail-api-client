...
class IFMapApiGenerator(object):
    ...
    def _generate_client_classes(self, gen_filepath_pfx, gen_filename_pfx):
        ...
        for ident in self._non_exclude_idents():
            ...
            write(gen_file, "        self._if_match = None")
            write(gen_file, "")
            ...
            write(gen_file, "")
            write(gen_file, "    @property")
            write(gen_file, "    def if_match(self):")
            write(gen_file, "        return self._if_match")
            write(gen_file, "")
            write(gen_file, "    @if_match.setter")
            write(gen_file, "    def if_match(self, last_modified):")
            write(gen_file, "        self._if_match = last_modified")
            write(gen_file, "")
